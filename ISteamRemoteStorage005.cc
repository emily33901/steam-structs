class ISteamRemoteStorage005 {
	...
	virtual unknown_ret PublishFile(char const*, char const*, unsigned int, char const*, char const*, ERemoteStoragePublishedFileVisibility, SteamParamStringArray_t*) = 0;
	virtual unknown_ret PublishWorkshopFile(char const*, char const*, unsigned int, char const*, char const*, SteamParamStringArray_t*) = 0;
