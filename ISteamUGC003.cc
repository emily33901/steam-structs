class ISteamUGC003 {
	...
	virtual unknown_ret GetItemInstallInfo(unsigned long long, unsigned long long*, char*, unsigned int, bool*) = 0;
	virtual unknown_ret GetItemUpdateInfo(unsigned long long, bool*, bool*, unsigned long long*, unsigned long long*) = 0;
};
