class ISteamRemoteStorage006 {
	...
	virtual unknown_ret PublishVideo(char const*, char const*, unsigned int, char const*, char const*, ERemoteStoragePublishedFileVisibility, SteamParamStringArray_t*) = 0;
