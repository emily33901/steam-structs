class ISteamNetworking003 {
	virtual unknown_ret SendP2PPacket(CSteamID, void const*, unsigned int, EP2PSend) = 0;
	virtual unknown_ret IsP2PPacketAvailable(unsigned int*) = 0;
	virtual unknown_ret ReadP2PPacket(void*, unsigned int, unsigned int*, CSteamID*) = 0;
